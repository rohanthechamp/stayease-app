                ...
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div className="px-8 py-6">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-primary-200/50 text-sm">
                    ...
                    <div className="px-8 pb-10">
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full rounded-xl bg-white text-primary-950 py-3 font-semibold hover:bg-primary-100 transition disabled:opacity-60"
                            >
                                {isLoading
                                    ? "Signing in..."
                                    : "Sign in with Email"}
